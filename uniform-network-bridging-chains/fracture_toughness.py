...
class FractureToughnessCharacterizer(Characterizer):
    ...
    cuFJCs that undergo scission. It inherits all attributes and methods
    from the ``Characterizer`` class.
    """
    ...
    def set_user_parameters(self):
        ...
        p.characterizer.chain_data_directory = (
            "./AFM_chain_tensile_test_curve_fit/"
        )
        ...
        # assuming that the bond lifetime is equal to the segment
        # lifetime
        chain_backbone_bond_type2beyer_2000_f_c_max_tau_nu_dict = {
            "c-c": [6.05, 4.72, 3.81, 3.07, 2.45],
            "si-o": [4.77, 3.79, 3.14, 2.61, 2.17]
        } # nN
        beyer_2000_tau_nu_list = [1e-12, 1e-6, 1e0, 1e6, 1e12] # sec
        beyer_2000_tau_nu_num = len(beyer_2000_tau_nu_list)
        beyer_2000_tau_nu_exponent_list = [
            int(floor(log10(abs(beyer_2000_tau_nu_list[tau_nu_indx]))))
            for tau_nu_indx in range(beyer_2000_tau_nu_num)
        ]
        beyer_2000_tau_nu_label_list = [
            r'$\textrm{WPRC}~(\hat{\varepsilon}_{c\nu}^{sci})^{crit},~\tau_{\nu}='+'10^{%g}~sec$' % (beyer_2000_tau_nu_exponent_list[tau_nu_indx])
            for tau_nu_indx in range(beyer_2000_tau_nu_num)
        ]
        beyer_2000_tau_nu_overline_label_list = [
            r'$\textrm{WPRC}~\overline{(\hat{\varepsilon}_{c\nu}^{sci})^{crit}},~\tau_{\nu}='+'10^{%g}~sec$' % (beyer_2000_tau_nu_exponent_list[tau_nu_indx])
            for tau_nu_indx in range(beyer_2000_tau_nu_num)
        ]
        beyer_2000_tau_nu_color_list = ['gainsboro', 'lightgrey', 'silver', 'darkgrey', 'grey']
        beyer_2000_tau_nu_linestyle_list = ['--', '--', '--', '--', '--']

        p.characterizer.chain_backbone_bond_type2beyer_2000_f_c_max_tau_nu_dict = (
            chain_backbone_bond_type2beyer_2000_f_c_max_tau_nu_dict
        )
        p.characterizer.beyer_2000_tau_nu_list = beyer_2000_tau_nu_list
        p.characterizer.beyer_2000_tau_nu_num = beyer_2000_tau_nu_num
        p.characterizer.beyer_2000_tau_nu_exponent_list = (
            beyer_2000_tau_nu_exponent_list
        )
        p.characterizer.beyer_2000_tau_nu_label_list = (
            beyer_2000_tau_nu_label_list
        )
        p.characterizer.beyer_2000_tau_nu_overline_label_list = (
            beyer_2000_tau_nu_overline_label_list
        )
        p.characterizer.beyer_2000_tau_nu_color_list = (
            beyer_2000_tau_nu_color_list
        )
        p.characterizer.beyer_2000_tau_nu_linestyle_list = (
            beyer_2000_tau_nu_linestyle_list
        )
    ...
    def characterization(self):
        ...
        nu = np.loadtxt(
            cp.chain_data_directory+data_file_prefix+'-cuFJC-curve-fit-intgr_nu'+'.txt')
        zeta_nu_char = np.loadtxt(
            cp.chain_data_directory+data_file_prefix+'-cuFJC-curve-fit-zeta_nu_char_intgr_nu'+'.txt')
        kappa_nu = np.loadtxt(
            cp.chain_data_directory+data_file_prefix+'-cuFJC-curve-fit-kappa_nu_intgr_nu'+'.txt')
        l_nu_eq = np.loadtxt(
            cp.chain_data_directory+data_file_prefix+'-cuFJC-curve-fit-l_nu_eq_intgr_nu'+'.txt')
        ...
        beyer_2000_f_c_max_tau_nu_list = (
            cp.chain_backbone_bond_type2beyer_2000_f_c_max_tau_nu_dict[chain_backbone_bond_type]
        ) # nN
        ...
        rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_cnu_sci_hat_crit___nu_chunk_list = []
        rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_c_sci_hat_crit___nu_chunk_list = []
        rate_independent_beyer_2000_f_c_max_tau_nu_g_c___nu_chunk_list = []
        rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_cnu_sci_hat_crit___nu_chunk_list = []
        rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_c_sci_hat_crit___nu_chunk_list = []
        rate_independent_beyer_2000_f_c_max_tau_nu_overline_g_c___nu_chunk_list = []

        rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_g_c___nu_chunk_list = []
        rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_overline_g_c___nu_chunk_list = []

        for nu_val in cp.nu_list:
            rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_cnu_sci_hat_crit = []
            rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_c_sci_hat_crit = []
            rate_independent_beyer_2000_f_c_max_tau_nu_g_c = []
            rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_cnu_sci_hat_crit = []
            rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_c_sci_hat_crit = []
            rate_independent_beyer_2000_f_c_max_tau_nu_overline_g_c = []

            rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_g_c = []
            rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_overline_g_c = []
            ...
            for f_c_max_val in beyer_2000_f_c_max_tau_nu_list:
                ...
                rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_cnu_sci_hat_crit.append(
                    epsilon_cnu_sci_hat_crit_val)
                rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_c_sci_hat_crit.append(
                    epsilon_c_sci_hat_crit_val)
                rate_independent_beyer_2000_f_c_max_tau_nu_g_c.append(
                    g_c_val)
                rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_cnu_sci_hat_crit.append(
                    overline_epsilon_cnu_sci_hat_crit_val)
                rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_c_sci_hat_crit.append(
                    overline_epsilon_c_sci_hat_crit_val)
                rate_independent_beyer_2000_f_c_max_tau_nu_overline_g_c.append(
                    overline_g_c_val)
                
                rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_g_c.append(
                    inext_gaussian_g_c_val)
                rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_overline_g_c.append(
                    inext_gaussian_overline_g_c_val)

            A_nu___nu_chunk_list.append(A_nu_val)
            inext_gaussian_A_nu___nu_chunk_list.append(inext_gaussian_A_nu_val)
            ...
            rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_cnu_sci_hat_crit___nu_chunk_list.append(
                rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_cnu_sci_hat_crit)
            rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_c_sci_hat_crit___nu_chunk_list.append(
                rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_c_sci_hat_crit)
            rate_independent_beyer_2000_f_c_max_tau_nu_g_c___nu_chunk_list.append(
                rate_independent_beyer_2000_f_c_max_tau_nu_g_c)
            rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_cnu_sci_hat_crit___nu_chunk_list.append(
                rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_cnu_sci_hat_crit)
            rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_c_sci_hat_crit___nu_chunk_list.append(
                rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_c_sci_hat_crit)
            rate_independent_beyer_2000_f_c_max_tau_nu_overline_g_c___nu_chunk_list.append(
                rate_independent_beyer_2000_f_c_max_tau_nu_overline_g_c)
            
            rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_g_c___nu_chunk_list.append(
                rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_g_c)
            rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_overline_g_c___nu_chunk_list.append(
                rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_overline_g_c)
        ...
        save_pickle_object(
            self.savedir, rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_cnu_sci_hat_crit___nu_chunk_list,
            data_file_prefix+"-rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_cnu_sci_hat_crit___nu_chunk_list")
        save_pickle_object(
            self.savedir, rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_c_sci_hat_crit___nu_chunk_list,
            data_file_prefix+"-rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_c_sci_hat_crit___nu_chunk_list")
        save_pickle_object(
            self.savedir,
            rate_independent_beyer_2000_f_c_max_tau_nu_g_c___nu_chunk_list,
            data_file_prefix+"-rate_independent_beyer_2000_f_c_max_tau_nu_g_c___nu_chunk_list")
        save_pickle_object(
            self.savedir,
            rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_cnu_sci_hat_crit___nu_chunk_list,
            data_file_prefix+"-rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_cnu_sci_hat_crit___nu_chunk_list")
        save_pickle_object(
            self.savedir,
            rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_c_sci_hat_crit___nu_chunk_list,
            data_file_prefix+"-rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_c_sci_hat_crit___nu_chunk_list")
        save_pickle_object(
            self.savedir, rate_independent_beyer_2000_f_c_max_tau_nu_overline_g_c___nu_chunk_list,
            data_file_prefix+"-rate_independent_beyer_2000_f_c_max_tau_nu_overline_g_c___nu_chunk_list")
        
        save_pickle_object(
            self.savedir,
            rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_g_c___nu_chunk_list,
            data_file_prefix+"-rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_g_c___nu_chunk_list")
        save_pickle_object(
            self.savedir, rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_overline_g_c___nu_chunk_list,
            data_file_prefix+"-rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_overline_g_c___nu_chunk_list")
        ...
        print("Rate-dependent strain-controlled AFM experiments")
    ...
    def finalization(self):
        ...
        ax1.semilogx(
            cp.nu_list, A_nu___nu_chunk_list, linestyle=cp.cufjc_A_nu_linestyle,
        ...
        for AFM_expermts_indx in cp.AFM_exprmts_indx_list:
            ax.plot(
                [], [],
                linestyle=cp.beyer_2000_tau_nu_linestyle_list[AFM_expermts_indx],
                color=cp.beyer_2000_tau_nu_color_list[AFM_expermts_indx],
                alpha=1, linewidth=2.5,
                label=cp.beyer_2000_tau_nu_label_list[AFM_expermts_indx])
        ax.plot(
            [], [],
        ...
        plt.semilogx(
            ...
            label=cp.LT_quarter_zeta_nu_char_label)
        for AFM_expermts_indx in cp.AFM_exprmts_indx_list:
            rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_cnu_sci_hat_crit_list = [
                rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_cnu_sci_hat_crit___nu_chunk_list[nu_chunk_indx][AFM_expermts_indx]
            ...
            plt.semilogx(
                ...
                alpha=1, linewidth=2.5,
                label=cp.beyer_2000_tau_nu_label_list[AFM_expermts_indx])
            print("epsilon_cnu_sci_hat_crit = {}".format(rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_cnu_sci_hat_crit_list[0]))
        plt.semilogx(
            cp.nu_list,
            rate_independent_epsilon_cnu_diss_hat_crit___nu_chunk_list,
            linestyle=cp.cufjc_linestyle, color=cp.cufjc_color,
            alpha=1, linewidth=2.5, label=cp.cufjc_label)
        print("rate independent epsilon_cnu_diss_hat_crit = {}".format(rate_independent_epsilon_cnu_diss_hat_crit___nu_chunk_list[0]))
        print("rate independent epsilon_cnu_diss_hat_crit = {}".format(rate_independent_epsilon_cnu_diss_hat_crit___nu_chunk_list[-1]))
        for f_c_dot_indx in range(cp.f_c_dot_num):
            ...
            plt.semilogx(
                ...
                alpha=1, linewidth=2.5,
                label=cp.f_c_dot_label_list[f_c_dot_indx])
            print("rate dependent epsilon_cnu_diss_hat_crit = {}".format(rate_dependent_frc_cntrld_AFM_exprmts_epsilon_cnu_diss_hat_crit_list[0]))
            print("rate dependent epsilon_cnu_diss_hat_crit = {}".format(rate_dependent_frc_cntrld_AFM_exprmts_epsilon_cnu_diss_hat_crit_list[-1]))
        ...
        for AFM_expermts_indx in cp.AFM_exprmts_indx_list:
            rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_cnu_sci_hat_crit_list = [
                rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_cnu_sci_hat_crit___nu_chunk_list[nu_chunk_indx][AFM_expermts_indx]
                for nu_chunk_indx in range(cp.nu_num)
            ]
            plt.semilogx(
                cp.nu_list,
                ...
                color=cp.beyer_2000_tau_nu_color_list[AFM_expermts_indx],
                alpha=1, linewidth=2.5,
                label=cp.beyer_2000_tau_nu_overline_label_list[AFM_expermts_indx])
        plt.semilogx(
            cp.nu_list,
            rate_independent_overline_epsilon_cnu_diss_hat_crit___nu_chunk_list,
            linestyle=cp.cufjc_linestyle, color=cp.cufjc_color,
        ...
        plt.semilogx(
            ...
            label=cp.LT_quarter_zeta_nu_char_label)
        for AFM_expermts_indx in cp.AFM_exprmts_indx_list:
            rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_c_sci_hat_crit_list = [
                rate_independent_beyer_2000_f_c_max_tau_nu_epsilon_c_sci_hat_crit___nu_chunk_list[nu_chunk_indx][AFM_expermts_indx]
                for nu_chunk_indx in range(cp.nu_num)
            ]
            plt.semilogx(
                cp.nu_list,
        ...
        plt.semilogx(
            ...
            label=cp.LT_overline_quarter_zeta_nu_char_label)
        for AFM_expermts_indx in cp.AFM_exprmts_indx_list:
            rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_c_sci_hat_crit_list = [
                rate_independent_beyer_2000_f_c_max_tau_nu_overline_epsilon_c_sci_hat_crit___nu_chunk_list[nu_chunk_indx][AFM_expermts_indx]
                for nu_chunk_indx in range(cp.nu_num)
            ]
            plt.semilogx(
                cp.nu_list,
        ...
        plt.loglog(
            ...
            label=cp.LT_quarter_zeta_nu_char_label)
        for AFM_expermts_indx in cp.AFM_exprmts_indx_list:
            rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_g_c_list = [
                rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_g_c___nu_chunk_list[nu_chunk_indx][AFM_expermts_indx]
                for nu_chunk_indx in range(cp.nu_num)
            ]
            plt.semilogx(
                cp.nu_list,
        ...
        plt.loglog(
            ...
            label=cp.LT_overline_quarter_zeta_nu_char_label)
        for AFM_expermts_indx in cp.AFM_exprmts_indx_list:
            rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_overline_g_c_list = [
                rate_independent_beyer_2000_f_c_max_tau_nu_inext_gaussian_overline_g_c___nu_chunk_list[nu_chunk_indx][AFM_expermts_indx]
                for nu_chunk_indx in range(cp.nu_num)
            ]
            plt.semilogx(
                cp.nu_list,
        ...
        for AFM_expermts_indx in cp.AFM_exprmts_indx_list:
            ...
            rate_independent_beyer_2000_f_c_max_tau_nu_g_c_list = [
                rate_independent_beyer_2000_f_c_max_tau_nu_g_c___nu_chunk_list[nu_chunk_indx][AFM_expermts_indx]
                for nu_chunk_indx in range(cp.nu_num)
            ]
            plt.semilogx(
                cp.nu_list,
        ...
        for AFM_expermts_indx in cp.AFM_exprmts_indx_list:
            ...
            rate_independent_beyer_2000_f_c_max_tau_nu_overline_g_c_list = [
                rate_independent_beyer_2000_f_c_max_tau_nu_overline_g_c___nu_chunk_list[nu_chunk_indx][AFM_expermts_indx]
                for nu_chunk_indx in range(cp.nu_num)
            ]
            plt.semilogx(
                cp.nu_list,
